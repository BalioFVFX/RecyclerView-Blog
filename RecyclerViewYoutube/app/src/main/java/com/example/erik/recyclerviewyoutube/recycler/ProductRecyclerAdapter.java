package com.example.erik.recyclerviewyoutube.recycler;
...
import com.example.erik.recyclerviewyoutube.R;
...
public class ProductRecyclerAdapter extends RecyclerView.Adapter<ProductRecyclerAdapter.ProductViewHolder> {
        ...
        public ProductViewHolder(@NonNull View itemView, final ICheckBoxListener iCheckBoxListener) {
            ...
            this.checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    iCheckBoxListener.onCheckListener(productDescriptionTextView, getAdapterPosition());
                }
            });
        }
    }
    ...
    public interface ICheckBoxListener{
        void onCheckListener(TextView textView, int position);
    }
}
