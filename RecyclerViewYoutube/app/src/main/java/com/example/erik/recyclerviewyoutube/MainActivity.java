package com.example.erik.recyclerviewyoutube;
...
import com.example.erik.recyclerviewyoutube.model.Product;
import com.example.erik.recyclerviewyoutube.recycler.ProductRecyclerAdapter;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity
implements ProductRecyclerAdapter.ICheckBoxListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ProductRecyclerAdapter(this.getApplicationContext(), products, this));
    }

    @Override
    public void onCheckListener(TextView textView, int position) {
        textView.setText(String.format("Position - %d", position));
    }
}
